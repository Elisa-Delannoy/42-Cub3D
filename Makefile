...
SOURCES = ./init_free.c ./main.c ./mini_map.c ./parsing/check_first_part_file.c ./parsing/check_map.c ./parsing/check_map_space.c ./parsing/check_map_wall.c ./parsing/color.c ./parsing/coordinates.c ./parsing/parse.c ./utils.c ./window.c 
